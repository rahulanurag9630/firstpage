...
function F1() {
  return (
    ...
    >
      <div className="w-8/12 p-5 h-auto bg-white rounded-lg mt-11 mb-11 flex flex-col lg:flex-row justify-evenly">
        <div className="lg:w-7/12 lg:order-2 w-full mt-5">
          <ToggeledForm />
        </div>
